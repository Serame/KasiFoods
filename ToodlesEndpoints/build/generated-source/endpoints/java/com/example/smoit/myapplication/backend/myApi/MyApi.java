...
package com.example.smoit.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.example.smoit.myapplication.backend.myApi.model.PlacedOrdersCollection> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.smoit.myapplication.backend.myApi.model.PlacedOrdersCollection.class);
